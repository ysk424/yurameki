...
_PARAMETERS = {
    ...
    "yurameki_bend_stiffness_log10": ("Bend Stiffness log10", "float", -8.0, 2.0, "rod bend/twist stiffness (log10); higher is stiffer/straighter, lower is floppier and whips more; -3 means 1e-3"),
