...
_PARAMETERS = {
    ...
    "yurameki_iterations": ("Iterations", "int", 1, 256, "Cosserat rod solver iterations; more converges stiffer"),
    "yurameki_stretch_compliance_log10": ("Stretch Compliance log10", "float", -12.0, 0.0, "rod stretch: higher is stretchier; -2 means 1e-2 (near-inextensible)"),
    "yurameki_bend_compliance_log10": ("Bend Compliance log10", "float", -12.0, 0.0, "rod bending: higher bends/whips more easily; -5 means 1e-5"),
